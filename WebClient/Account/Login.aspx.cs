...
namespace WebClient.Account
{
    ...
    public partial class Login : Page
    {
        ...
        protected void LogIn(object sender, EventArgs e)
        {
            ...
            {
                 tmp = false;
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "AlertBox", "alert('Не верно введены данные!');", true);
            }
